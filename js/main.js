(function () {
    ...
    function updateShareLinks() {
        ...
        document.querySelector(".share.twitter").href = "http://twitter.com/intent/tweet?text=" + encodeURIComponent(Url.queryString("title") + " for dummies #FORDUMMIES") + "&url=" + encodeURIComponent(link);
